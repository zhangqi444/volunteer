...
- **Catalog**: opportunities Sheila can do now: Seattle Humane's youth projects, Seattle Children's youth service projects, and cat and animal work around Seattle (RASKC's Shelter Helper from age 9 with a parent, PAWS Preteen Workshops and at-home projects, The NOAH Center's Kid's Day, and family fostering with Seattle Area Feline Rescue, the Seattle Animal Shelter and Homeward Pet). Each carries its source URL and check date, and shows *Fits now*, *With an adult*, or *Age not stated* against the volunteer's age. *Log hours* or *Plan it* on a card creates the organization and work item behind it on first use, so logging is one step; the Log hours dialog has the same picker.
