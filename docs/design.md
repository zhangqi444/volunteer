...
| Reports | Something to hand over | Period presets, organization filter, volunteer name; summary tiles, by organization, by work item, detailed log, signature lines; print styles hide everything else. |
