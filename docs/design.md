...
| Catalog | Choose something to do | Filters (search, fit, organization, what it is, how she takes part, tag, area). Each card: title linking to the opportunity's own page, what it is, how she takes part, fit badge, organization link, summary, tags, *Details* (sources, ages, how-to, contact, check date), interest picker, **Log hours**, **Plan it**, and a link to its work item once one exists. |
